...
- **Boot Button**: Download button. Pressing **Reset** and then pressing **Boot** when the LED is purple initiates Firmware Download mode for downloading firmware through the serial port or USB port.
